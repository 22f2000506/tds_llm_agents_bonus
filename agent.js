/**
 * Cookie - Advanced AI Assistant
 * v2.8.0 (Updated: AI Pipe integration + bug fixes)
 * Author: Matlin Jeleshiya (Original) & Assistant (fixes)
 */
class Cookie {
    constructor() {
        this.version = '2.8.0';
    ...
    async init() {
        try {
            ...
            console.log(`Cookie v${this.version} initialized successfully`);
        } catch (error) {
    ...
    displayMessage(message) {
        try {
            ...
            const senderName = { user: 'You', assistant: 'Cookie', system: 'System', tool: 'Tool' }[message.role] || message.role;
    ...
    showWelcomeMessage() {
        ...
        if (conv && conv.messages.length === 0) {
            this.addMessage('assistant', 'Welcome to Cookie! How can I assist you?');
        }
    }
